...
class JL{
        ...
        if(data){
            for(let i in data){
                ...
                Object.defineProperty(this.data, i, {
                    ...
                    set: (value) => {
                        this[i] = value;
                        this._innerData.bindingVariable2domActionMapping[i].forEach((fn) => {fn()})
                    }
                });
            }
        }
    ...
    handleSettingValue(dom, bindingModalVariableName){
        ...
        this._innerData.bindingVariable2domActionMapping[bindingModalVariableName].push(domTextAction)
    }
